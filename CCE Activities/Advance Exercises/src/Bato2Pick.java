...
public class Bato2Pick {
    ...
    public static void main(String[] args) {
        ...
        while (willPlay.equalsIgnoreCase("y")) {
            ...
            while (!gameEnds) {
                ...
                gameEnds = checkIfSomeoneWon(playerPoints, computerPoints, gameEnds);
    ...
    private static boolean checkIfSomeoneWon(int playerPoints, int computerPoints, boolean gameEnds) {
